...
export const TABLE_COLUMNS: TableColumn<IPurchasePaymentReturn>[] = [
  {
    key: 'payNumber',
    label: 'Pay Number',
    icon: Hash,
  ...
  {
    key: 'returnedPurchaseInvoiceNumber',
    label: 'Returned Purchase Invoice Number',
    icon: Hash,
  },
  {
    key: 'supplierName',
...
export const HEADER_BUTTONS: IPageAction[] = [
  {
    key: 'add',
    buttonConfig: {
      label: 'Add Purchase Payment Return',
      variant: 'primary',
      icon: Plus,
      type: 'button',
    },
