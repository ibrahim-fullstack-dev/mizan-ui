...
// 📐 constants
import { TABLE_COLUMNS, HEADER_BUTTONS, TABLE_ACTIONS } from './purchase-payments.constant';
@Component({
...
export class PurchasePaymentsComponent {
  private readonly rawExpenses = signal<IPurchasePayment[]>([
    {
      id: 1,
  ...
  protected onTableActionTrigger(event: TableActionEvent<IPurchasePayment>): void {
  ...
  protected onRowsSelected(selectedClients: IPurchasePayment[]): void {
  ...
  private openEditClientModal(client: IPurchasePayment): void {
