...
// 📐 constants
import { TABLE_COLUMNS, HEADER_BUTTONS, TABLE_ACTIONS } from './client-payments.constant';
@Component({
...
export class ClientPaymentsComponent {
  private readonly rawExpenses = signal<IClientPayment[]>([
    {
      id: 1,
  ...
  protected onTableActionTrigger(event: TableActionEvent<IClientPayment>): void {
  ...
  protected onRowsSelected(selectedClients: IClientPayment[]): void {
  ...
  private openEditClientModal(client: IClientPayment): void {
