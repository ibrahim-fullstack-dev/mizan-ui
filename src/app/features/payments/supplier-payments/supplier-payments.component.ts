...
// 📐 constants
import { TABLE_COLUMNS, HEADER_BUTTONS, TABLE_ACTIONS } from './supplier-payments.constant';
@Component({
...
export class SupplierPaymentsComponent {
  private readonly rawExpenses = signal<ISupplierPayment[]>([
    {
      id: 1,
  ...
  protected onTableActionTrigger(event: TableActionEvent<ISupplierPayment>): void {
  ...
  protected onRowsSelected(selectedClients: ISupplierPayment[]): void {
  ...
  private openEditClientModal(client: ISupplierPayment): void {
