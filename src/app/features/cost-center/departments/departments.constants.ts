// src/app/features/departments/departments.constants.ts
...
import { Plus, Pencil, Trash2, Eye, BriefcaseBusiness, Info, Search } from 'lucide-angular';
...
export const TABLE_COLUMNS: TableColumn<IDepartment>[] = [
  {
    key: 'name',
    label: 'Name',
