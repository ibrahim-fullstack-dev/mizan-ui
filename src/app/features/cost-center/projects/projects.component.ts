...
import { IDepartment } from './projects.types';

// 📐 constants
import { TABLE_COLUMNS, HEADER_BUTTONS, TABLE_ACTIONS } from './projects.constant';
@Component({
...
export class ProjectsComponent {
  private readonly rawDeprtmentsData = signal<IDepartment[]>([
    {
      id: 1,
      name: 'project 1',
      status: 'active',
  ...
  protected onTableActionTrigger(event: TableActionEvent<IDepartment>): void {
  ...
  protected onRowsSelected(selectedClients: IDepartment[]): void {
  ...
  private openEditClientModal(client: IDepartment): void {
