// src/app/features/warehouse/warranties/warranties.constants.ts
...
import { Plus, Eye, Pencil, Trash2, FileKey, Type, Clock5, File, Search } from 'lucide-angular';
...
export const TABLE_COLUMNS: TableColumn<IWarranty>[] = [
  {
    key: 'name',
    label: 'Name',
    icon: FileKey,
