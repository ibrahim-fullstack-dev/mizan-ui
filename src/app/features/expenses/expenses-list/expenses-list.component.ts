...
// 📐 constants
import { TABLE_COLUMNS, HEADER_BUTTONS, TABLE_ACTIONS } from './expenses-list.constant';
@Component({
  selector: 'app-client',
  standalone: true,
...
export class ExpensesListComponent {
  ...
  protected readonly filteredExpenses = computed(() => {
    ...
    return this.rawExpenses().filter((client) => client.branch.toLowerCase().includes(query));
  });
