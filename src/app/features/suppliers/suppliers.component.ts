...
// 📐 constants
import { TABLE_COLUMNS, HEADER_BUTTONS, TABLE_ACTIONS } from './suppliers.constant';
@Component({
  selector: 'app-client',
  standalone: true,
...
export class SuppliersComponent {
  private readonly rawClients = signal<ISupplier[]>([
  ...
  protected onTableActionTrigger(event: TableActionEvent<ISupplier>): void {
  ...
  protected onRowsSelected(selectedClients: ISupplier[]): void {
  ...
  private openEditClientModal(client: ISupplier): void {
